...
void bonusTray()
{
	middleDrive(-350, 50);
	moveClaw(250, 50);
	fourWheelDrive(4170, 0, fourSpeed);
	fourWheelDrive(-425, 0, fourSpeed);
	waitUntilMotorStop(leftDriveMotor);
	rightSensorTracking(2, lineSpeed, 0);
	middleDrive(55, 25);
	fourWheelDrive(500, 0, fourSpeed);
	waitUntilMotorStop(leftDriveMotor);
	fourWheelDrive(-500, 0, fourSpeed);
}
...
// Scoring Tray
		...
		moveClaw(350, 75);
		allign(bumpHeading, alingSpeed);
		rightSensorTracking(1, lineSpeed, bumpHeading);
		fourWheelDrive(500, bumpHeading, fourSpeed);
		fourWheelDrive(-475, bumpHeading, fourSpeed);
		middleDrive(700, 100);
		fourWheelDrive(500, bumpHeading, fourSpeed);
		fourWheelDrive(-475, bumpHeading, fourSpeed);
